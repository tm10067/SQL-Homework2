...
/* Добавим поле жанры в таблицу Фильмы */
...
/* Заполним поле жанров в таблице Фильмы для существующих записей */ 
...
/* Сделаем выборку фильмов, выпущенных в 90 годы */    
...
SELECT film_name 
 ...
 SELECT film_name, IF (production_year < 2000, 'старый', 'новый') AS 'год выпуска'
   FROM film
